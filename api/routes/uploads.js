...
const imageStorage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, imagesPath(req.body.prefix))
  },
...
router.post(
  ...
  (req, res) => {
    ...
    const original = imagesPath(prefix) + filename
    const thumb = thumbsPath(prefix) + filename
