  ...
  <div>
    <client-only>
      ...
      >
        <div
          :class="
            'resp-sharing-button resp-sharing-button--facebook resp-sharing-button--' +
            size
          "
        >
          <div
      ...
      <a
        class="resp-sharing-button__link"
        :href="`https://twitter.com/intent/tweet/?text=${currentDescription}&amp;url=${currentUrl}`"
        target="_blank"
        rel="noopener"
        aria-label="Twitter"
      >
        <div
          :class="
            'resp-sharing-button resp-sharing-button--twitter resp-sharing-button--' +
            size
          "
        >
          <div
      ...
      <a
        class="resp-sharing-button__link"
        :href="`https://www.linkedin.com/shareArticle?mini=true&amp;url=${currentUrl}&amp;title=${currentTitle}&amp;summary=${currentDescription}&amp;source=${currentUrl}`"
        target="_blank"
        rel="noopener"
        aria-label="LinkedIn"
      >
        <div
          :class="
            'resp-sharing-button resp-sharing-button--linkedin resp-sharing-button--' +
            size
          "
        >
          <div
      ...
      <a
        class="resp-sharing-button__link"
        :href="`whatsapp://send?text=${currentDescription}%20${currentUrl}`"
        target="_blank"
        rel="noopener"
        aria-label="WhatsApp"
      >
        <div
          :class="
            'resp-sharing-button resp-sharing-button--whatsapp resp-sharing-button--' +
            size
          "
        >
          <div
      ...
      <a
        class="resp-sharing-button__link"
        :href="`https://telegram.me/share/url?text=${currentDescription}&amp;url=${currentUrl}`"
        target="_blank"
        rel="noopener"
        aria-label="Telegram"
      >
        <div
          :class="
            'resp-sharing-button resp-sharing-button--telegram resp-sharing-button--' +
            size
          "
        >
          <div
      ...
      <a
        class="resp-sharing-button__link"
        :href="`mailto:?subject=${currentDescription}&amp;body=${currentUrl}`"
        target="_self"
        rel="noopener"
        aria-label="E-Mail"
      >
        <div
          :class="
            'resp-sharing-button resp-sharing-button--email resp-sharing-button--' +
            size
          "
        >
          <div
